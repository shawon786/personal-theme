 ...
 * Credits to http://www.wpbeginner.com/wp-theme/how-to-add-numeric-pagination-in-your-wordpress-theme/
 */

if ( ! function_exists( 'themeeo_pagination' ) ) :
function themeeo_pagination() {
	if ( is_singular() ) {
		return;
	}
	...
	echo '<nav aria-label="Page navigation" class="text-xs-center"><ul class="pagination ">' . "\n";
